...
print('='*90)
print(' sz300936 (中英科技) - 四技能联合分析报告 '.center(90, '='))
print('='*90)
print(f'分析时间: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}')
print(f'技能组合: mootdx-astock + stock-analysis + a-share-short-decision + chanlun')
print('='*90)
...
print('\n' + '【二、技术指标分析】stock-analysis'.ljust(90, '-'))
...
print(f'    位置:  {boll_pos:.1f}% (0%=下轨, 100%=上轨)')

# ========== 技能3: a-share-short-decision - 短期决策 ==========
print('\n' + '【三、短期决策信号】a-share-short-decision'.ljust(90, '-'))
